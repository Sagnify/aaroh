...
export default function CourseDetails() {
  ...
  useEffect(() => {
    if (course) {
      ...
      const seoDesc = course.seoDescription || course.subtitle || course.description
      
      document.title = `${seoTitle} - Aaroh Music Academy`
      ...
      metaDesc.content = `${seoDesc} - Learn online with Aaroh Music Academy. ${course.lessons} lessons, ${course.duration} of content. Enroll now!`
      ...
      if (course.seoKeywords) {
        ...
        metaKeywords.content = course.seoKeywords
      }
      ...
      ogTitle.content = `${seoTitle} - Aaroh Music Academy`
      ...
      twitterTitle.content = `${seoTitle} - Aaroh Music Academy`
  ...
  return (
    ...
    <BreadcrumbSchema items={[
      { name: 'Home', url: 'https://aaroh.com' },
      { name: 'Courses', url: 'https://aaroh.com/courses' },
      { name: course.title, url: `https://aaroh.com/courses/${params.id}` }
    ]} />
