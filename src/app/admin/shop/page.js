                ...
                <div className="bg-white dark:bg-zinc-950 border-0 md:border dark:border-zinc-800 shadow-sm rounded-none md:rounded-lg mx-0">
                  ...
                  {paginatedOrders.map((order) => (
                    <div key={order.id} className="hover:bg-gray-50 dark:hover:bg-zinc-900 transition-colors">
                        <div className="px-4 md:px-6 py-4 md:py-5 cursor-pointer hover:bg-gray-50 dark:hover:bg-zinc-900 transition-colors" onClick={() => router.push(`/admin/shop/order-details/${order.id}`)}>
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 border-2 ${
                                  product.isFeatured
                                    ? 'bg-gradient-to-r from-yellow-400 to-orange-400 text-white border-yellow-500 shadow-lg hover:shadow-xl transform hover:scale-105'
